...
const Navbar = () => {
    ...
    return (
        <header className="text-gray-600 body-font">
            <div className="container mx-auto flex justify-around p-5 items-center flex-row">
                <div className='s-name'>
                    <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        ...
                        <span className="ml-3 text-xl dark:text-white">X-MEN</span>
                    </a>
                </div>
                <div className='v-name'>
                    <nav className="flex items-center text-base justify-center">
                        ...
                        <div className='buttons'>
                            {click ? <div className='click block md:hidden'>
                                <ul className='flex flex-col fixed top-[4.8rem] border border-slate-50 bg-slate-100 p-3 right-6 rounded-md mx-auto'>
                                    <li>
                            ...
                            <button className='md:hidden block transition' onDragExit={handleMouse} onClick={handleClick}>
