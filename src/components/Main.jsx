                ...
                <div className="container px-5 my-10 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 dark:text-white">
                            ...
                            <h1 className="text-gray-900 text-3xl title-font dark:text-white font-medium mb-1">The Catcher in the Rye</h1>
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 text-indigo-500 dark:text-white" viewBox="0 0 24 24">
                                        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                    </svg>
                                    <span className="text-gray-600 ml-3 dark:text-gray-500">4 Reviews</span>
                                </span>
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                <div className="flex ml-6 items-center ">
                                    ...
                                    <div className="relative">
                                        <select className="rounded-lg border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10 dark:text-black">
                                            <option>SM</option>
                                            <option>M</option>
                                            <option>L</option>
                                            <option>XL</option>
